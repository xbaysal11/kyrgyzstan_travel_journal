...
checkWidth();
function checkWidth() {
    var windowWidth = $('body').innerWidth(), elem1 = $(".tours__menu_tab"), elem2 = $(".kgdays__menu_tab");
    if (windowWidth > 500) {
...
$(document).ready(function(){
    $('.js-slick_welcome-slider').slick({
        nextArrow: '<img src="../wp-content/themes/marvel/img/akirova.com/svg/arrow-right.svg" class="slick-next">',
        prevArrow: '<img src="../wp-content/themes/marvel/img/akirova.com/svg/arrow-left.svg" class="slick-prev">',
        autoplay: false,
        dots: true
});
});
...
$(document).ready(function(){
    $('.kg-main-slider--js').slick({
        nextArrow: '<img src="../tours/wp-content/themes/marvel/img/akirova.com/svg/arrow-right.svg" class="slick-next">',
        prevArrow: '<img src="../tours/wp-content/themes/marvel/img/akirova.com/svg/arrow-left.svg" class="slick-prev">',
        autoplay: true,
        dots: false
    });
});
...
function filterTab(thisTab){
    if(filterTab != thisTab){
        $('figure').filter('.'+thisTab).show();
        $('figure').filter(':not(.'+thisTab+')').hide();
    }
}
...
function filterKgTab(thisTab){
    if(filterKgTab != thisTab){
        $('.kg-tours-cards--item').filter('.'+thisTab).show();
        $('.kg-tours-cards--item').filter(':not(.'+thisTab+')').hide();
        $('.kg-tours__title p').filter('.'+thisTab).show();
        $('.kg-tours__title p').filter(':not(.'+thisTab+')').hide();
    }
}
...
$(".included").click(function() {
    ...
    $(".included-content").toggleClass("active").siblings().removeClass("active");
    $(this).toggleClass("active").siblings().removeClass("active");
    $(".included img").toggleClass("active").siblings().removeClass("active");
});
...
$(".img").each(function(){
    $(this).find("img").click(function(){
        $(".full-image").find("img").attr("src", $(this).attr("src"));
    });
});
